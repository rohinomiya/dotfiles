...
" Last Change:  2012/02/07 01:41:185
"
...
"csharp
call <SID>Add_word_pair('base',    'this')
call <SID>Add_word_pair('this',    'base')

call <SID>Add_word_pair('ref',    'out')
call <SID>Add_word_pair('out',    'ref')

call <SID>Add_word_pair('var',    'bool')
call <SID>Add_word_pair('bool',    'int')
call <SID>Add_word_pair('int',    'string')
call <SID>Add_word_pair('string',    'void')
call <SID>Add_word_pair('void',    'var')

call <SID>Add_word_pair('public',    'private')
call <SID>Add_word_pair('private',    'protected')
call <SID>Add_word_pair('protected',    'public')
"call <SID>Add_word_pair('protected',    'friend')
"call <SID>Add_word_pair('friend', 'public')
